...
function applyCouponReducer(state = {couponCode:''}, action) {
  switch (action.type) {
    ...
    case REMOVE_DISCOUNT_SUCCESS:
        return { loading: false, discount: '' };
    default: return state;
  }
}

export {
  userSigninReducer,userNormalEmptyCartReducer, userRegisterReducer,userEmptyCartReducer,
   userEmailVerifyReducer,userUpdateReducer, userResetPasswordReducer, userResetPasswordLinkReducer,
   userAddToCartReducer,userUpdateCartReducer,userDeleteFromCartReducer,userCartItemsListReducer,
   applyCouponReducer,
}