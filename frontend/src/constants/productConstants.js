...
export const NORMAL_PRODUCT_LIST_REQUEST = 'NORMAL_PRODUCT_LIST_REQUEST';
export const NORMAL_PRODUCT_LIST_SUCCESS = 'NORMAL_PRODUCT_LIST_SUCCESS';
export const NORMAL_PRODUCT_LIST_FAIL = 'NORMAL_PRODUCT_LIST_FAIL';
